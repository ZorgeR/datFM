...
public class datFM_Protocol_Adaptor extends ArrayAdapter<datFM_File> {
    ...
    public datFM_Protocol_Adaptor(Context context, int LayoutID, List<datFM_File> objects, boolean[] selected) {
